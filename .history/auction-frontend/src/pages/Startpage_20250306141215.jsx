...
const bidData = [
    { id: 1, item: 'Vintage Watch', currentBid: '$150' },
    { id: 2, item: 'Antique Vase', currentBid: '$200' },
    { id: 3, item: 'Rare Painting', currentBid: '$500' }
];
const renderBidItems = () => {
    return bidData.map(bid => (
        <div key={bid.id} style={{ margin: '20px 0', padding: '20px', border: '1px solid #ddd', borderRadius: '5px' }}>
            <h2>{bid.item}</h2>
